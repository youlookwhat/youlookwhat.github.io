...
Extremely fast HTTP Archive ([HAR](http://www.softwareishard.com/har-12-spec/)) validator using JSON Schema.
...
- **data**: `Object` *(Required)*
  a full [HAR](http://www.softwareishard.com/har-12-spec/) object
...
- **data**: `Object` *(Required)*
  a [log](http://www.softwareishard.com/har-12-spec/#log) object
...
- **data**: `Object` *(Required)*
  a [cache](http://www.softwareishard.com/har-12-spec/#cache) object
...
- **data**: `Object` *(Required)*
  a ["beforeRequest" or "afterRequest"](http://www.softwareishard.com/har-12-spec/#cache) objects
...
- **data**: `Object` *(Required)*
  a [content](http://www.softwareishard.com/har-12-spec/#content) object
...
- **data**: `Object` *(Required)*
  a [cookie](http://www.softwareishard.com/har-12-spec/#cookies) object
...
- **data**: `Object` *(Required)*
  a [creator](http://www.softwareishard.com/har-12-spec/#creator) object
...
- **data**: `Object` *(Required)*
  an [entry](http://www.softwareishard.com/har-12-spec/#entries) object
...
- **data**: `Object` *(Required)*
  a [page](http://www.softwareishard.com/har-12-spec/#pages) object
...
- **data**: `Object` *(Required)*
  a [pageTimings](http://www.softwareishard.com/har-12-spec/#pageTimings) object
...
- **data**: `Object` *(Required)*
  a [postData](http://www.softwareishard.com/har-12-spec/#postData) object
...
- **data**: `Object` *(Required)*
  a [record](http://www.softwareishard.com/har-12-spec/#headers) object
...
- **data**: `Object` *(Required)*
  a [request](http://www.softwareishard.com/har-12-spec/#request) object
...
- **data**: `Object` *(Required)*
  a [response](http://www.softwareishard.com/har-12-spec/#response) object
...
- **data**: `Object` *(Required)*
  a [timings](http://www.softwareishard.com/har-12-spec/#timings) object
